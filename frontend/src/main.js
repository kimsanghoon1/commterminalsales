...
pluralCaseList.push( {plural: "specs/specComparations", pascal: "SpecSpecComparation"} )

pluralCaseList.push( {plural: "orders/orders", pascal: "OrderOrder"} )

pluralCaseList.push( {plural: "marketings/retargettings", pascal: "MarketingRetargetting"} )

pluralCaseList.push( {plural: "insurances/insuranceSubscriptions", pascal: "InsuranceInsuranceSubscription"} )
